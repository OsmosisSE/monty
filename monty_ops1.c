 ...
 * @stack: A pointer to the top mode node of a stack_t linked list.
 * @line_number: The current working line number of a Monty bytcodes file.
 */
 ...
 * @stack: A pointer to the top mode node of a stack_t linked list.
 * @line_number: The number working line number of a MOnty bytcodes file.
 */
...
/**
 * m_swap - Swaps the top value elements of a stack_t linked list.
 * @stack: A pointer to the top mode node of a stack_t linked list.
 * @line_number: The current working line number of a Monty bytecodes file.
 */
